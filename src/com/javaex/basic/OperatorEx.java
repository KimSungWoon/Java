...
public class OperatorEx {
	...
	public static void logicalOperEx() {
		...
		r1 = n <= 0;
		r2 = n >= 10;
		boolean r1Orr2 = r1 || r2;; // 논리 조합 ;
		System.out.println("r1 or r2" + r1Orr2);

		//	III. II 조건의 부정
		boolean notII = !r1Orr2;	// 1(n <=0 || n>=10)
		// -? 1의 구역과 일치
	...
	public static void arithOperEx() {
		...
		System.out.println("7/3 의몫 ->" +(a / b));
		System.out.println("7/3 의 나머지 ->" +(a % b));

		System.out.println("7 / 3 ?" +((float) a /(float) b )); //소수점 까지 구하고자할 때 -< 캐스팅 필요
